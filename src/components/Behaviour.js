    ...
    <div className='w-10/12 bg-white shadow-md p-4 mr-3 p-8 my-4'>
      <div className='flex flex-row justify-between items-center'>
        ...
        <div className='flex flex-row items-center'>     
          <button className={'font-bold rounded-md mt-6 p-3 bg-gray-100 text-gray-900 hover:bg-gray-200'}>Browsers</button>
          <button className={'font-bold rounded-md mt-6 p-3 text-gray-900 hover:bg-gray-200'}>Decides</button>
...
export default React.memo(Behaviour);